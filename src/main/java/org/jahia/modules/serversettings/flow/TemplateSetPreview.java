...
/**
 * This class contains information about template set preview resources used in the UI to present the template sets
 * visually.
 */
public class TemplateSetPreview {
    ...
    public TemplateSetPreview(JahiaTemplatesPackage jahiaTemplatesPackage, List<String> previewResources) {
        this.jahiaTemplatesPackage = jahiaTemplatesPackage;
        this.previewResources = previewResources;
    }
    ...
    public void setPreviewResources(List<String> previewResources) {
        this.previewResources = previewResources;
    }
}
